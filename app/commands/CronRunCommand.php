...
class CronRunCommand extends Command
{
    ...
    public function fire()
    {
        ...
        $this->everyMinute(function () {
            ...
            $user_name = 'Leonardo';
            $mensagem = 'Mensagem de Aviso de CRON JOB';
            $subject = 'Aviso de CRON JOB a cada 1 minutos vindo do SERVIDOR';
            ...
            $this->messages[] = "Your email has been sent successfully";
        });
        /*
        $this->everyFiveMinutes(function()
        {
            ...
            $user_name 	= 'Leonardo';
            $mensagem 	= 'Mensagem de Aviso de CRON JOB';
            $subject 	= 'Aviso de CRON JOB por minuto';
