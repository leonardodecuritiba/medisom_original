...
<div class="form-group pj">
    <div class="col-sm-4">
        <label for="contato" class="control-label">Pessoa de Contato <span class="text-danger">*</span></label>
        <input type="text" class="form-control" name="contato" required>
    </div>
    <div class="col-sm-4">
        <label for="contato" class="control-label">CNPJ <span class="text-danger">*</span></label>
        <input type="text" class="form-control" name="cnpj" required>
    </div>

    <div class="col-sm-4">
        <label for="contact_email" class="control-label">Inscr. Estadual <span class="text-danger">*</span></label>
        <input type="email" class="form-control" name="ie" required>
    </div>
</div>
...
<div class="form-group pj">
    ...
    <div class="col-sm-12 ">
        <label for="doc_cnpj" class="control-label">Copia do CNPJ <span class="text-danger">*</span></label>
        <input type="file" class="form-control" name="doc_cnpj" required>
    </div>
    <div class="col-sm-12 ">
        <label for="doc_ie" class="control-label">Copia da Inscr. Estadual <span class="text-danger">*</span></label>
        <input type="file" class="form-control" name="doc_ie" required>
    </div>
    <div class="col-sm-12">
