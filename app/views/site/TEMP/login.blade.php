    ...
    <div class="container">
        ...
        <div class="mt40 row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                @endif
                <div class="loginbox">
                    <form action="{{URL::route('login',array('action'=>'authorize'))}}" method="post"
                          class="form-vertical">
                        <fieldset>
                            ...
                            <a class="orange">Esqueceu a senha?</a> <br>
                            <br>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="loginbox">
                    ...
                    <br>
                    <br>
                    <a href="{{URL::route('register')}}" class="btn btn-orange">Continue</a></div>
            </div>
        </div>
    </div>
    <!-- Newsletter-->
