...
<head>
    ...
    <title>Administração do Blog | Medisom</title>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="table-responsive panel-collapse pull out">
                        <table class="table table-bordered table-hover" id="table1">
                                    ...
                                    <tr class="@if($post->status == 'inactive') danger @endif">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="media-object">
                                                <img src="{{ asset('public/uploads/'.$url_imagem) }}" alt="" class="">
                                            </div>
                                        </td>
                                        <td>{{$post->title}}</td>
                                        <td>{{$post->status}}</td>
                                        ...
                                        <td class="text-right">
                                            <a href="{{URL::route('admin.blog',array('post_id'=>$post->post_id))}}"><i
                                                        class="fa fa-edit"></i>Editar</a>
                                            <a href="{{URL::route('admin.blog',array('post_id'=>$post->post_id,'action'=>$post->status))}}">
                                                @if($post->status == 'publish') <i class="fa fa-eye-slash"></i>
                                                Desativar @else <i class="fa fa-eye"></i>Ativar @endif
                                            </a>
                                            <a href="{{URL::route('admin.blog',array('post_id'=>$post->post_id,'action'=>'delete'))}}"
                            ...
                            @else
                                <tr class="warning">
                                    <td class="text-center" colspan="4">Nenhum post ainda. <a
                                                href="{{URL::route('admin.blog',array('post_id'=>0,'action'=>'novo'))}}">Clique
