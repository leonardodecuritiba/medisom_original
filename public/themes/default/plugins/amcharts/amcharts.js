...
(function () {
    ...
    d.AxisBase = d.Class({
        ...
        addEventListeners: function (a, b) {
            ...
            var u, x = this.gridAlpha, z, v = this.choosePeriod(0), A = v.period, v = v.count, y = d.getPeriodDuration(A, v);
            ...
            q = this.firstTime;
            var C = 0, J = 0;
            a && 1 < v && (u = this.chooseMinorFrequency(v), z = d.getPeriodDuration(A, u), "DD" == A && (z += d.getPeriodDuration("hh")));
            if (0 < this.gridCountR)for (B - 5 - k >
                ...
                "MM" == A && (h = (p - l) / y, 1.5 <= (p - l) / y && (p = p - (h - 1) * y + d.getPeriodDuration("DD", 3), p = d.resetDateToMin(new Date(p), A, 1).getTime(), C += y));
                ...
                (J = -y * this.stepWidth / 2) : "date" == this.type && (h = this.axisWidth - h);
                f = !1;
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(u))for (h = 1; h < v; h += u)this.gridAlpha = this.minorGridAlpha, f = p + z * h, f = d.resetDateToMin(new Date(f), A, u, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
                this.gridAlpha = x
            }
...
(function () {
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            a = {
                x: a, y: b, text: c,
                align: e, size: d, color: f, alpha: k, rotation: g, bold: l, url: m, enabled: !0
            };
        ...
        cleanChart: function () {
            ...
            if (this.animations)for (a = this.animations.length - 1; 0 <= a; a--) {
                var b = this.animations[a], c = d.updateRate * b.time, e = b.frame + 1, h = b.obj,
                    f = b.attribute;
                if (e <= c) {
                    b.frame++;
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                ...
                l && (p && p.remove(), "function" == typeof l ? (l = new l, l.chart = e, a.bulletConfig && (l.availableSpace = c, l.graph = this, l.graphDataItem = a, l.bulletY = c, a.bulletConfig.minCoord = this.minCoord - c, l.bulletConfig = a.bulletConfig), l.write(h), p && l.showBullet && l.set.push(p), a.customBulletGraphics = l.cset, p = l.set) : (p = h.set(), l = h.image(l,
                    0, 0, g, g), p.push(l), this.centerCustomBullets && l.translate(-g / 2, -g / 2)));
                if (p) {
                ...
                if (p) {
                    p.size = g || 0;
                    if (e = this.bulletHitAreaSize)h = d.circle(h, e, "#FFFFFF", .001, 0), h.translate(b,
                        c), a.hitBullet = h, this.bulletSet.push(h), this.addListeners(h, a);
                    a.bulletGraphics = p
                } else p = {size: 0};
                p.graphDataItem = a;
                return p
        ...
        fixBulletSize: function () {
            ...
            if (g && g.enabled && this.showBalloon && !this.hidden) {
                ...
                m && "" !== m ? (e = f.getBalloonColor(this, a), g.drop || (g.pointerOrientation = b), b = a.x, h = a.y, f.rotate && (b = a.y, h = a.x), b += k, h += l, isNaN(b) || isNaN(h) ? this.hideBalloonReal() : (a = this.width, q = this.height,
                n && g.setBounds(k, l, a + k, q + l), g.changeColor(e), g.setPosition(b, h), g.fixPrevious(), g.fixedPosition && (c = !1), !c && "radar" != f.type && (b < k || b > a + k || h < l - .5 || h > q + l) ? (g.showBalloon(m), g.hide(0)) : (g.followCursor(c), g.showBalloon(m)))) : (this.hideBalloonReal(), this.resizeBullet(a, e, h))
